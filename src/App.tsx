...
/* ═══════════════════════════════════════════════════════════════════════════
   CONSTANTS
═══════════════════════════════════════════════════════════════════════════ */
const PHONES = ['+7 (906) 964-58-08', '+7 (3852) 69-65-08'];
    ...
    <>
      <header className={`header-blur fixed top-0 left-0 right-0 z-50 ${scrolled ? 'scrolled' : ''}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          {/* Logo */}
          <a href="#" className="flex items-center gap-2 text-lg sm:text-xl font-black tracking-tight">
            <span className="text-[var(--accent)]">КИТ</span>
            <span>РЕЙД</span>
          </a>
          ...
          {/* Desktop CTA */}
          <a href="#contacts" className="btn-accent hidden lg:inline-flex px-5 py-2.5 text-sm">
            Связаться
          </a>
      ...
      <div className={`mobile-menu lg:hidden ${menuOpen ? 'open' : ''}`}>
        <div className="flex items-center justify-between mb-10">
          ...
          <button className="burger open flex flex-col gap-[6px] p-2" onClick={() => setMenuOpen(false)} aria-label="Закрыть">
            <span />
            <span />
            <span />
          </button>
        ...
        <a href="#contacts" className="btn-accent px-6 py-3 text-base mt-8" onClick={() => setMenuOpen(false)}>
          Связаться
        </a>
      </div>
    </>
...
function Hero() {
  return (
    <section className="relative hero-min-h flex items-center justify-center overflow-hidden grid-bg">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-5xl mx-auto px-5 sm:px-6 lg:px-8 text-center pt-24 pb-8 sm:pt-20 sm:pb-0">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full sm:w-auto px-4 sm:px-0">
          <a href="#gallery" className="btn-accent w-full sm:w-auto px-6 sm:px-8 py-3.5 text-sm sm:text-base">
            Каталог запчастей
            <IconArrow />
          </a>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            <a href="#contacts" className="btn-accent inline-flex px-6 py-3 text-sm mt-2 sm:mt-4">
    ...
    <section id="gallery" className="relative py-14 sm:py-20 lg:py-28 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="relative group rounded-2xl overflow-hidden lg:row-span-2 min-h-[220px] sm:min-h-[280px] lg:min-h-0">
            <img src="/images/car1.jpg" alt="Седаны и купе" loading="lazy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
            {/* overlay */}
          ...
          {/* Card 2 */}
          <div className="relative group rounded-2xl overflow-hidden min-h-[200px] sm:min-h-[240px]">
            <img src="/images/car2.jpg" alt="SUV и кроссоверы" loading="lazy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
            <div className="absolute inset-0 rounded-2xl border border-white/0 group-hover:border-[var(--accent)]/30 transition-colors duration-300" />
            <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5 sm:p-6">
              <span className="inline-flex items-center gap-1 text-[var(--accent)] text-[10px] sm:text-xs font-bold tracking-widest uppercase mb-1 sm:mb-2">
          ...
          <div className="relative group rounded-2xl overflow-hidden min-h-[200px] sm:min-h-[240px]">
            <img src="/images/car3.jpg" alt="Спорт и премиум" loading="lazy" className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
            <div className="absolute inset-0 rounded-2xl border border-white/0 group-hover:border-[var(--accent)]/30 transition-colors duration-300" />
            <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5 sm:p-6">
              <span className="inline-flex items-center gap-1 text-[var(--accent)] text-[10px] sm:text-xs font-bold tracking-widest uppercase mb-1 sm:mb-2">
          ...
          <div className="md:col-span-2 lg:col-span-3 glass rounded-2xl p-4 sm:p-5 sm:p-6 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            ...
            <a href="#contacts" className="btn-accent w-full sm:w-auto px-6 py-2.5 text-sm flex-shrink-0 justify-center">
        ...
        <div className="video-frame">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="play-btn">
              <svg viewBox="0 0 24 24" fill="#050505" className="w-6 h-6 ml-1">
              ...
              <>
                          ...
                          <div className="grid grid-cols-3 gap-2 sm:gap-3">
                            {['WhatsApp', 'Telegram', 'Звонок'].map((m) => (
                              <button
                                ...
                                className={`quiz-option py-3 text-center !px-2 sm:!px-3 ${form.messenger === m ? 'selected' : ''}`}
                              >
                ...
                <div className="quiz-nav flex items-center justify-between mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-white/6">
                  {step > 0 ? (
                    <button
                      onClick={goBack}
                      className="btn-ghost px-4 sm:px-5 py-2.5 text-sm"
                    >
                  ...
                  <button onClick={goNext} className="btn-accent px-6 sm:px-8 py-3 text-sm">
              ...
              <div className="quiz-success-enter text-center py-6 sm:py-8">
                ...
                <div className="mt-4 sm:mt-6">
                  <button
                    onClick={() => {
                      setStep(0);
                      setForm({ service: '', details: '', name: '', phone: '', messenger: 'WhatsApp' });
                      setSubmitted(false);
                      setAnimKey((k) => k + 1);
                    }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 sm:gap-6">
          ...
          <div className="contact-card">
            ...
            <a href="mailto:info@kitreade.ru" className="text-sm hover:text-[var(--accent)] transition-colors">
              info@kitreade.ru
            </a>
          </div>
